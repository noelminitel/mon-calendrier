...
AuthAccount.prototype.Connect = function()
{
    ...
    // Tente de vérifier si un token est déjà présent ou déclenche l'état déconnecté au départ
    this.onSignOut();
}
...
{
    if (this.tokenClient) {
        // Demande un token (ouvre la popup de connexion Google si nécessaire)
