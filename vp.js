//////////////////////////////////////////////////////////////////////
// vp.js - Contrôleur principal AngularJS et logique de l'application

function vp_main($scope, $timeout) {

    // Initialisation des vues et des états
    $scope.view = "home";
    $scope.signed_in = false;
    $scope.sign_msg = "Not signed in";
    $scope.busy = false;

    // Options pour les sélecteurs de colonnes dans les paramètres
    ...
    // Connexion avec l'objet AuthAccount défini dans vip_oauth.js
    ...
    // Événements des boutons de l'interface
